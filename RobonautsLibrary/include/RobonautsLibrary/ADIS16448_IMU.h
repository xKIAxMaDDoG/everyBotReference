...
class ADIS16448_IMU : public GyroBase
{
 ...
 private:
  ...
  wpi::priority_mutex m_samples_mutex;
// BEGINNING 2019   wpi::priority_condition_variable m_samples_not_empty;
