 ...
 *
 ******************************************************************************/
class RSpeedControllerTalonSRXCan : public RSpeedController
{
    public:
        RSpeedControllerTalonSRXCan(int port_device, int controlPeriodMs);
        ~RSpeedControllerTalonSRXCan();
        ...
        ControllerType GetSpeedControllerType() { return(TALON_SRX); };

    private:
        ctre::phoenix::motorcontrol::can::WPI_TalonSRX m_controller;
};
