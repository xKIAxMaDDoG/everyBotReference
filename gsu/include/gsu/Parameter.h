...
/*******************************************************************************
 *
 * The Parameter class provides a static wrapper around an instance of
...
class Parameter
{
	public:
        ...
        static double        get(std::string name, double default_val = 0.0);
        ...
        static void     put(std::string name, double value);
